...
public final class LaunchListQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("launchess", arguments: ["after": GraphQLVariable("cursor")], type: .nonNull(.object(Launchess.selections))),
      ]
    }
    ...
    public init(launchess: Launchess) {
      self.init(unsafeResultMap: ["__typename": "Query", "launchess": launchess.resultMap])
    }

    public var launchess: Launchess {
      get {
        return Launchess(unsafeResultMap: resultMap["launchess"]! as! ResultMap)
      }
      set {
        resultMap.updateValue(newValue.resultMap, forKey: "launchess")
      }
    }

    public struct Launchess: GraphQLSelectionSet {
