    ...
    classDeclarationForOperation(operation, outputIndividualFiles, suppressMultilineStringLiterals) {
        ...
        this.classDeclaration({
            ...
            if (fragmentsReferenced.size > 0) {
                this.printNewlineIfNeeded();
                this.printOnNewline(language_1.swift `public var queryDocument: String`);
                this.withinBlock(() => {
                    this.printOnNewline(language_1.swift `var document: String = operationDefinition`);
                    fragmentsReferenced.forEach(fragmentName => {
                        this.printOnNewline(language_1.swift `document.append("\\n" + ${this.helpers.structNameForFragmentName(fragmentName)}.fragmentDefinition)`);
                    });
                    this.printOnNewline(language_1.swift `return document`);
                });
            }
            this.printNewlineIfNeeded();
