...
export declare class Helpers {
    ...
    mapExpressionForType(type: GraphQLType, isConditional: boolean | undefined, makeExpression: (expression: string) => string, expression: string, inputTypeName: string, outputTypeName: string): string;
}
