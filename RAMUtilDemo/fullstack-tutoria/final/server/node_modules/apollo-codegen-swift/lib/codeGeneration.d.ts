...
export declare function generateSource(context: CompilerContext, outputIndividualFiles: boolean, only?: string): SwiftAPIGenerator;
export declare class SwiftAPIGenerator extends SwiftGenerator<CompilerContext> {
    ...
    structDeclarationForFragment({ fragmentName, selectionSet, source }: Fragment): void;
    ...
    structDeclarationForVariant({ structName, adoptedProtocols, variant, typeCase }: {
        ...
        variant: Variant;
        typeCase?: TypeCase;
    }, before?: Function, after?: Function): void;
