...
#define RAM_FUNCTIONNAME_EXPORT __attribute__((used, section("__DATA, __funcName"))) \
...
#define RAM_BLOCKS_EXPORT(key, block) __attribute__((used, section("__DATA," "__"#key ".block"))) \
